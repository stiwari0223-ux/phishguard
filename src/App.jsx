  ...
  const handleCheck = () => {
    ...
    setTimeout(() => {
      ...
      setStats(prev => ({
        ...
        blocked: prev.blocked + (analysis.riskScore >= 60 ? 1 : 0)
      }));
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 640px) {
          ...
          /* Test vector chips: allow wrapping, decent tap size */
          .mobile-panel .flex-wrap button {
            min-height: 32px;
          ...
          /* Vulnerability rows: stack label and score cleanly */
          .vuln-row {
            flex-wrap: wrap;
            gap: 8px;
          }

          .vuln-row > span:last-child {
            margin-left: auto;
          }
        }
                ...
                <div className="holo-border p-4 sm:p-6 lg:p-8">
                  <div className="mobile-result-header flex flex-col sm:flex-row sm:items-start gap-4 mb-5 sm:mb-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className={`text-2xl font-bold mb-1 font-mono break-words ${
                    ...
                    <div className={`text-3xl sm:text-4xl font-bold font-mono px-4 sm:px-4 py-2 border-2 w-full sm:w-auto text-center shrink-0 ${
                    ...
                    {scanHistory.map((scan, idx) => (
                      <div key={idx} className="text-xs border border-cyan-700/30 p-2 bg-black/30 backdrop-blur-sm">
                        <div className="flex items-center justify-between mb-1 gap-2">
                          ...
                          <span className="text-cyan-700 font-mono shrink-0">{scan.timestamp.split(',')[1]}</span>
                        </div>
